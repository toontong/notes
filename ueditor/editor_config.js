...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["ClearDoc","SelectAll","Undo","Redo","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","DirectionalityLtr","DirectionalityRtl","Indent","Superscript","Subscript","RemoveFormat","FormatMatch","AutoTypeSet","PastePlain","FontFamily","FontSize","PageBreak","Date","Time","Horizontal","|","Spechars","HighlightCode","InsertUnorderedList","InsertOrderedList","Link","Unlink","SearchReplace","Preview","Print"],[],[]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'cleardoc':'','selectall':'','undo':'','redo':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','directionalityltr':'','directionalityrtl':'','indent':'','superscript':'','subscript':'','removeformat':'','formatmatch':'','autotypeset':'','pasteplain':'','fontfamily':'','fontsize':'','pagebreak':'','date':'','time':'','horizontal':'','|':'','spechars':'','highlightcode':'','insertunorderedlist':'','insertorderedlist':'','link':'','unlink':'','searchreplace':'','preview':'','print':''}
